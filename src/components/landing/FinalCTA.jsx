  ...
  return (
    <section className="py-20 lg:py-28 bg-navy-900 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-600/15 mb-8">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button
              size="lg"
              onClick={scrollTo}
              className="bg-blue-600 hover:bg-blue-500 text-white font-bold text-base px-8 py-6 rounded-xl shadow-lg shadow-blue-600/30 gap-2"
            >
              FAZER COTAÇÃO
